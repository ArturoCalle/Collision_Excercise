...
public:
	...
	static void SolveCollisionSquareEdge(ASphereShape* Sphere, ASquareShape* Square, FVector ContactPoint);
	...
	static float SweepLineTest(ASphereShape* Sphere, ALineShape* Line, FVector* ContactPoint, float DesiredDelta);
	static float SweepSquareTest(ASphereShape* Sphere, ASquareShape* Square, FVector* ContactPoint, float DesiredDelta, UWorld* WorldContext);
